  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
      ...
      <Tabs defaultValue="logins" className="space-y-6">
        ...
        {/* Agent Activity and Support Access tabs were removed — those
            histories live in /agents and /settings respectively, so duplicating
            them here just spread the same data across more screens. */}
